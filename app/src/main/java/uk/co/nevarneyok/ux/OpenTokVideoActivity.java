...
import uk.co.nevarneyok.controllers.OpenTokRestApiController;
import uk.co.nevarneyok.Service.ClearNotificationService;
import uk.co.nevarneyok.Service.ClearNotificationService.ClearBinder;
import uk.co.nevarneyok.config.OpenTokConfig;
import uk.co.nevarneyok.ux.AudioLevelView;
import uk.co.nevarneyok.ux.fragments.PublisherStatusFragment;
import uk.co.nevarneyok.ux.fragments.SubscriberControlFragment;
import uk.co.nevarneyok.ux.fragments.SubscriberQualityFragment;
import uk.co.nevarneyok.ux.fragments.PublisherControlFragment;

public class OpenTokVideoActivity extends AppCompatActivity implements Session.SessionListener ,
...
//        myFirebaseRef.child("users").child(id).child("connections").child(connectionKey).child("callanswer").setValue(103);
    ...
    public void loadInterface() {
        setContentView(R.layout.activity_open_tok_video);
    ...
    public void onPause() {
        ...
        Intent notificationIntent = new Intent(this, OpenTokVideoActivity.class);
        ...
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className, IBinder binder) {
                    ((ClearBinder) binder).service.startService(new Intent(OpenTokVideoActivity.this, ClearNotificationService.class));
        ...
        if (!mIsBound) {
            ...
            bindService(new Intent(OpenTokVideoActivity.this,
    ...
    public void setPubViewMargins() {
        RelativeLayout.LayoutParams pubLayoutParams = (RelativeLayout.LayoutParams) mPublisherViewContainer
                .getLayoutParams();
        int bottomMargin = 0;
        ...
        if (pubControlContainer != null && pubStatusContainer != null) {
            ...
            RelativeLayout.LayoutParams pubControlLayoutParams = (RelativeLayout.LayoutParams) pubControlContainer.getLayoutParams();
            RelativeLayout.LayoutParams pubStatusLayoutParams = (RelativeLayout.LayoutParams) pubStatusContainer.getLayoutParams();
        ...
        if (mSubscriber != null) {
            if (mSubscriberAudioOnly) {
                RelativeLayout.LayoutParams subLayoutParams = (RelativeLayout.LayoutParams) mSubscriberAudioOnlyView
                        .getLayoutParams();

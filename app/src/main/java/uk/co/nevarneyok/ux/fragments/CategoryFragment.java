...
import uk.co.nevarneyok.entities.Metadata;
import uk.co.nevarneyok.entities.SortItem;
import uk.co.nevarneyok.entities.drawerMenu.DrawerItemCategory;
import uk.co.nevarneyok.entities.filtr.Filters;
import uk.co.nevarneyok.entities.product.Product;
import uk.co.nevarneyok.entities.product.ProductListResponse;
import uk.co.nevarneyok.interfaces.CategoryRecyclerInterface;
import uk.co.nevarneyok.interfaces.FilterDialogInterface;
import uk.co.nevarneyok.listeners.OnSingleClickListener;
import uk.co.nevarneyok.utils.Analytics;
import uk.co.nevarneyok.utils.EndlessRecyclerScrollListener;
...
import uk.co.nevarneyok.ux.adapters.ProductsRecyclerAdapter;
import uk.co.nevarneyok.ux.adapters.SortSpinnerAdapter;
import uk.co.nevarneyok.ux.dialogs.FilterDialogFragment;

...
import uk.co.nevarneyok.entities.product.ProductColor;
import uk.co.nevarneyok.entities.product.ProductSize;
import uk.co.nevarneyok.entities.product.ProductVariant;
import uk.co.nevarneyok.interfaces.LoginDialogInterface;
import uk.co.nevarneyok.interfaces.ProductImagesRecyclerInterface;
import uk.co.nevarneyok.interfaces.RelatedProductsRecyclerInterface;
import uk.co.nevarneyok.interfaces.RequestListener;
import uk.co.nevarneyok.listeners.OnSingleClickListener;
import uk.co.nevarneyok.utils.Analytics;
...
import uk.co.nevarneyok.ux.adapters.ColorSpinnerAdapter;
import uk.co.nevarneyok.ux.adapters.ProductImagesRecyclerAdapter;
import uk.co.nevarneyok.ux.adapters.RelatedProductsRecyclerAdapter;
import uk.co.nevarneyok.ux.adapters.SizeVariantSpinnerAdapter;
import uk.co.nevarneyok.ux.dialogs.LoginDialogFragment;
import uk.co.nevarneyok.ux.dialogs.LoginExpiredDialogFragment;
import uk.co.nevarneyok.ux.dialogs.ProductImagesDialogFragment;

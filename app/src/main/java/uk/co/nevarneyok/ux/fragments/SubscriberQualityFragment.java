...
import uk.co.nevarneyok.ux.fragments.SubscriberControlFragment.SubscriberCallbacks;
...
public class SubscriberQualityFragment extends Fragment {
    ...
    public void showSubscriberWidget(boolean show) {
        if (show) {
            switch (congestion) {
                case High:
                    this.congestionIndicator.setImageResource(R.mipmap.high_congestion);
                    break;
                case Mid:
                    this.congestionIndicator.setImageResource(R.mipmap.mid_congestion);
                    break;
                case Low:
                    break;
